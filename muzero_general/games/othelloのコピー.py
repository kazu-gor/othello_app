...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (3, 4, 4)  # (channels, height, width) # TODO
        self.action_space = list(range(4 * 4))  # Fixed list of all possible actions. You should only edit the length #TODO
        ...
        self.max_moves = 16  # Maximum number of moves if game is not finished before # TODO
...
class Othello:
    def __init__(self):
        self.board_size = 4 #TODO
        self.board = numpy.zeros((self.board_size, self.board_size), dtype="int32")
        self.board[1][1], self.board[2][2], self.board[1][2], self.board[2][1] = 1, 1, -1, -1 # TODO
        self.player = 1
        self.board_markers = [
    ...
    def reset(self):
        self.board = numpy.zeros((self.board_size, self.board_size), dtype="int32")
        self.board[1][1], self.board[2][2], self.board[1][2], self.board[2][1] = 1, 1, -1, -1
        self.player = 1
    ...
    def get_observation(self):
        ...
        board_to_play = numpy.full((4, 4), self.player, dtype="int32") # TODO
