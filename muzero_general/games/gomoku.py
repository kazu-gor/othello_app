...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (3, 6, 6)  # Dimensions of the game observation, must be 3 (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        self.action_space = list(range(6 * 6))  # Fixed list of all possible actions. You should only edit the length
